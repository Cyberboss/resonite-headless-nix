...
let
  ...
  init-script = pkgs.writeShellScriptBin init-script-name ''
    ...
    ${(if cfg.enable-rml then "cp -rf ${rml}/* ${headless-directory}/ && mkdir -p ${headless-directory}/rml_mods && chmod 770 ${headless-directory}/rml_mods && chmod 770 ${headless-directory}/Libraries && chmod 660 ${headless-directory}/Libraries/*" else "")}
